...
void all_init_particles(int num_particles, particle_t* particles) {
    ...
    for (i = 0; i < num_particles; i++) {
        ...
        particle->pos = calloc(1, sizeof(struct vector));
        particle->vel = calloc(1, sizeof(struct vector));
        particle->force = calloc(1, sizeof(struct vector));
...
void free_particles(int num_particles, particle_t* particles) {
...
int main(int argc, char** argv) {
    ...
    free_particles(nparticles, particles);
    return 0;
}
